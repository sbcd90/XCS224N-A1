...
\begin{enumerate}
    \item Access the notebook here: \url{http://bit.ly/2rZZj1y}.
    
    \item If this is the first time you have opened a Google CoLab notebook, you will see jumbled text. Click Open With and then Connect More Apps
    
    \begin{center}
      \includegraphics[width=0.5\textwidth]{colab1.png}
    \end{center}

    \item Search 'colaboratory' and click +Connect once you have found Google CoLaboratory.

    \begin{center}
      \includegraphics[width=0.5\textwidth]{colab2.png}
    \end{center}

    \item An Open With Google Colaboratory option will now be available.
  
    \begin{center}
      \includegraphics[width=0.5\textwidth]{colab3.png}
    \end{center}
...
each question in the |src-word2vec/submission.py| file.  A sample response to the might
looks like this:
